...
use AppBundle\Entity\PioneerparkAdmin;
...
class AdminController extends AbsController
{
    ...
    public function indexAction()
    {
        ...
        $pagination = $this->get('admin_service')->getPageList('AppBundle:PioneerparkAdmin', $page, 15,
    ...
    {
        $id = $this->request()->get('id');
        if (!$this->get('admin_service')->delete('AppBundle:PioneerparkAdmin', $id)) {
    ...
    public function editAction()
    {
        ...
        $adminEntry = $adminService->findById('AppBundle:PioneerparkAdmin', $id);
