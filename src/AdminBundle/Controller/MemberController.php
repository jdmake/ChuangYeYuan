...
class MemberController extends AbsController
{
    ...
    public function indexAction()
    {
        ...
        $pagination = $this->get('admin_member_service')->getPageList('AppBundle:PioneerparkMember', $page, 15,
            function (QueryBuilder $query) use ($search) {
                $query
                    ...
                    ->innerJoin('AppBundle:PioneerparkMemberProfile', 'b', 'WITH', 'a.profileid=b.id');
                if ($search != '') {
    ...
    public function editAction()
    {
        ...
        if ($this->request()->getMethod() == 'POST') {
            ...
            // 保存数据
            $member = $this->get('admin_member_service')->findById('AppBundle:PioneerparkMember', $id) ;
    ...
    public function findUserAction()
    {
        ...
        $query->select('a.uid,b.nickname,b.avatar')
            ->from('AppBundle:PioneerparkMember', 'a')
            ->innerJoin('AppBundle:PioneerparkMemberProfile', 'b', 'WITH', 'a.profileid=b.id');
