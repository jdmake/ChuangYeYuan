    ...
    var r = function (c, j) {
        ...
        function i(a) {
            if (!s) {
                ...
                if (d) {
                    this.commit(e, d);
                    for (var a = [].concat(a), f = a.length, c, g = 0; g < f; g++) (c = b.getContentElement.apply(b, a[g].split(":"))) && c.setup(e, d)
                }
                s = 0
            }
        }

        var e = 1, k = /^\s*(\d+)((px)|\%)?\s*$/i, v = /(^\s*(\d+)((px)|\%)?\s*$)|^$/i, o = /^\d+px$/,
            w = function () {
                ...
                if ("check" == b) {
                    if (!a.userlockRatio && "true" == d.getCustomData("isReady")) {
                        var f = a.getValueOf("info", "txtWidth"), c = a.getValueOf("info", "txtHeight"),
                            d = 1E3 * d.$.width / d.$.height, e = 1E3 * f / c;
                        a.lockRatio = !1;
                ...
                a.lockRatio ?
                    f.removeClass("cke_btn_unlocked") : f.addClass("cke_btn_unlocked");
                ...
                if ("true" == b.getCustomData("isReady")) {
                    var d = a.getContentElement("info", "txtWidth"), c = a.getContentElement("info", "txtHeight");
                ...
                if (a == e) {
                    var c = this.getDialog(), g = "", h = "txtWidth" == this.id ? "width" : "height", i = b.getAttribute(h);
                    i && (g = d(i, g));
                    g = d(b.getStyle(h), g);
                    this.setValue(g)
                }
                    ...
                    type: "vbox", padding: 0, children: [{
                        type: "hbox", widths: ["280px", "110px"], align: "right", children: [{
                            id: "txtUrl", type: "text", label: c.lang.common.url, required: !0, onChange: function () {
                                ...
                                a == e && (this.getValue() || this.isChanged()) ? (b.data("cke-saved-src", this.getValue()), b.setAttribute("src",
                        ...
                        id: "basic", type: "vbox", children: [{
                            type: "hbox", requiredContent: "img{width,height}", widths: ["50%", "50%"], children: [{
                                type: "vbox", padding: 1, children: [{
                                ...
                                },
                                    {
                                        ...
                                        commit: function (a, b, d) {
                                            var f = this.getValue();
                                            a == e ? (f && c.activeFilter.check("img{width,height}") ? b.setStyle("height", CKEDITOR.tools.cssLength(f)) : b.removeStyle("height"), !d && b.removeAttribute("height")) : 4 == a ? f.match(k) ? b.setStyle("height",
                                                CKEDITOR.tools.cssLength(f)) : (a = this.getDialog().originalElement, "true" == a.getCustomData("isReady") && b.setStyle("height", a.$.height + "px")) : 8 == a && (b.removeAttribute("height"), b.removeStyle("height"))
                                        }
                                    }]
                            }, {
                                id: "ratioLock",
                            ...
                            type: "vbox", padding: 1, children: [{
                                ...
                                commit: function (a, b, d) {
                                    ...
                                    a == e || 4 == a ? (isNaN(c) ? !c && this.isChanged() && b.removeStyle("border") : (b.setStyle("border-width",
                                        CKEDITOR.tools.cssLength(c)), b.setStyle("border-style", "solid")), !d && a == e && b.removeAttribute("border")) : 8 == a && (b.removeAttribute("border"), b.removeStyle("border-width"), b.removeStyle("border-style"), b.removeStyle("border-color"))
                                }
                            }, {
                                type: "text",
                                id: "txtHSpace",
                                ...
                                commit: function (a, b, d) {
                                    var c = parseInt(this.getValue(), 10);
                                    a == e || 4 == a ? (isNaN(c) ? !c && this.isChanged() && (b.removeStyle("margin-left"), b.removeStyle("margin-right")) : (b.setStyle("margin-left", CKEDITOR.tools.cssLength(c)), b.setStyle("margin-right", CKEDITOR.tools.cssLength(c))),
                                    !d && a == e && b.removeAttribute("hspace")) : 8 == a && (b.removeAttribute("hspace"), b.removeStyle("margin-left"), b.removeStyle("margin-right"))
                                }
                            }, {
                                type: "text",
                                id: "txtVSpace",
                                ...
                                commit: function (a, b, c) {
                                    ...
                                    a == e || 4 == a ? (isNaN(f) ? !f && this.isChanged() && (b.removeStyle("margin-top"), b.removeStyle("margin-bottom")) : (b.setStyle("margin-top", CKEDITOR.tools.cssLength(f)), b.setStyle("margin-bottom", CKEDITOR.tools.cssLength(f))), !c && a == e && b.removeAttribute("vspace")) : 8 == a && (b.removeAttribute("vspace"),
                                ...
                                commit: function (a, b, c) {
                                    var f = this.getValue();
                                    if (a == e || 4 == a) {
                                        if (f ? b.setStyle("float", f) : b.removeStyle("float"), !c && a == e) switch (f = (b.getAttribute("align") || "").toLowerCase(), f) {
                                            case "left":
                                            case "right":
                ...
                id: "advanced", label: c.lang.common.advancedTab, elements: [{
                    ...
                    setup: function (a,
                        ...
                        if (a == e) {
                            ...
                            this.setValue(c);
                            var f = b.$.style.height, c = b.$.style.width, f = (f ? f : "").match(k),
                                c = (c ? c : "").match(k);
